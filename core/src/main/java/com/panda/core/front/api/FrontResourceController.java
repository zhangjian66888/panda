 ...
 */
@RestController
@RequestMapping(CoreConst.FRONT_REQUEST_PREFIX + "resource")
public class FrontResourceController {
    ...
    @PostMapping("search")
    public Mono<ResultDto<PageDto<PandaRoleDto>>> search(@RequestBody FrontRoleSo search) {
    ...
    public ResultDto<PageDto<PandaRoleDto>> searchOld(@RequestBody FrontRoleSo search) {
