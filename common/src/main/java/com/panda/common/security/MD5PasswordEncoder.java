package com.panda.common.security;
...
/**
 * com.panda.common.security.MD5PasswordEncoder
 * <p>
 * DATE 2019/9/3
 *
 * @author zhanglijian.
...
public class MD5PasswordEncoder implements PasswordEncoder {
    ...
    public String encode(String rawPassword) {
        return saltMd5AndSha(rawPassword);
    }

    @Override
    public boolean matches(String rawPassword, String encodedPassword) {
        return saltverifyMd5AndSha(rawPassword, encodedPassword);
    }
     ...
     */
    public static String saltMd5AndSha(String password) {
        // 生成一个16位的随机数
